...
typedef short int 		t__int16_t;
typedef unsigned short int 	t__uint16_t;
typedef int 			t__int32_t;
typedef unsigned int 		t__uint32_t;
typedef long long int 		t__int64_t;
typedef unsigned long long int 	t__uint64_t;

__ASSERT(sizeof(t__int8_t) == 1);
__ASSERT(sizeof(t__uint8_t) == 1);
__ASSERT(sizeof(t__int16_t) == 2);
__ASSERT(sizeof(t__uint16_t) == 2);
__ASSERT(sizeof(t__int32_t) == 4);
__ASSERT(sizeof(t__uint32_t) == 4);
__ASSERT(sizeof(t__int64_t) == 8);
__ASSERT(sizeof(t__uint64_t) == 8);

/*
 * This file uses snake case, but you can cast safely.
*/

typedef t__uint16_t	Elf32_Half;
typedef t__uint16_t 	Elf64_Half;
typedef t__uint32_t 	Elf32_Word;
typedef	t__int32_t  	Elf32_Sword;
typedef t__uint32_t 	Elf64_Word;
typedef	t__int32_t  	Elf64_Sword;
typedef t__uint64_t 	Elf32_Xword;
typedef	t__int64_t  	Elf32_Sxword;
typedef t__uint64_t 	Elf64_Xword;
typedef	t__int64_t  	Elf64_Sxword;
typedef t__uint32_t 	Elf32_Addr;
typedef t__uint64_t 	Elf64_Addr;
typedef t__uint32_t 	Elf32_Off;
typedef t__uint64_t 	Elf64_Off;
typedef t__uint16_t 	Elf32_Section;
typedef t__uint16_t 	Elf64_Section;
typedef Elf32_Half 	Elf32_Versym;
typedef Elf64_Half 	Elf64_Versym;

typedef Elf32_Half	elf32_half;
typedef Elf64_Half	elf64_half;
typedef Elf32_Word	elf32_word;
typedef	Elf32_Sword	elf32_sword;
typedef Elf64_Word	elf64_word;
typedef	Elf64_Sword	elf64_sword;
typedef Elf32_Xword	elf32_xword;
typedef	Elf32_Sxword	elf32_sxword;
typedef Elf64_Xword	elf64_xword;
typedef	Elf64_Sxword	elf64_sxword;
typedef Elf32_Addr	elf32_addr;
typedef Elf64_Addr	elf64_addr;
typedef Elf32_Off	elf32_off;
typedef Elf64_Off	elf64_off;
typedef Elf32_Section	elf32_section;
typedef Elf64_Section	elf64_section;
...
{
	t__uint32_t a_type;		/* Entry type */
	union
	{
		t__uint32_t a_val;		/* Integer value */
...
{
	t__uint64_t a_type;		/* Entry type */
	union
	{
		t__uint64_t a_val;		/* Integer value */
		/* We use to have pointer elements added here.  We cannot do that,
		   though, since it does not work when using 32-bit definitions
		   on 64-bit platforms and vice versa.  */
	} a_un;
